...
export default function SvgTitleLogo(props) {
  
  // Logo icon for Title
  // Inline styles related to alignment of elements only. Theming is handled in CSS module
  return (
    <div style={{marginTop: '.85vh', paddingTop: '.25em'}} >
      <svg className={props.className} xmlns="http://www.w'3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
